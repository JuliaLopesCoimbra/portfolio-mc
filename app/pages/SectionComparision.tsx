  ...
  return (
    <li
      className={cn(
        ...
        type === "bad"
          ? "border-red-200 bg-white/10 text-red-100"
          : "border-green-200 bg-white/10 text-green-100"
      )}
    >
      {type === "bad" ? (
        <FaTimesCircle className="mt-0.5 text-red-500" />
      ) : (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-7xl px-6 md:px-10 justify-center text-center">
        ...
        <h2 className="mt-2 text-balance text-3xl font-semibold leading-tight text-white sm:text-4xl">
          Outras consultorias <span className="text-violet-700">x</span> Muscle
          Club
        </h2>
        <p className="mt-2 text-sm text-white/80">
          Veja o que nos diferencia e porque nossos alunos conseguem
          consistência, suporte e resultado real.
        </p>

        <div className="mt-10 grid gap-6 md:grid-cols-2">
          {/* Outras consultorias */}
          <div className="rounded-3xl border border-red-200 bg-white/5 p-6 shadow-sm backdrop-blur">
            <h3 className="mb-4 text-lg font-semibold text-red-500">
              Outras consultorias
            </h3>
            <ul className="space-y-2">
              <Item type="bad">
                Entregam treinos e dietas prontos ou feitos por robô, sem
                personalização pra sua realidade
              </Item>
              <Item type="bad">
                Falta acompanhamento: após te enviarem o plano, somem e não te
                dão o suporte que você precisa para evoluir.
              </Item>
          ...
          {/* Muscle Club */}
          <div className="rounded-3xl border border-green-200 bg-white/5 p-6 shadow-sm backdrop-blur">
            <h3 className="mb-4 text-lg font-semibold text-green-500">
              Muscle Club
            </h3>
            <ul className="space-y-2">
              <Item type="good">
                Treinos e dietas 100% personalizados para você. Sem IA ou
                ctrl+c/ctrl+v.
              </Item>
              <Item type="good">
                Planos simples, práticos e possíveis de seguir. Treino e dieta
                feitos para caber na sua rotina, não o contrário.
              </Item>
              <Item type="good">
                Contato direto com o especialista responsável.
              </Item>
              ...
              <Item type="good">
                Acesso gratuito à Muscle Club Academy. Te ensinamos o que te
                prescrevemos.{" "}
              </Item>
            </ul>
          </div>
        ...
        <div className="mt-12 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
          <div>
            <h3 className="text-lg font-semibold text-white">
              Pronto para alcançar o melhor shape da sua vida com acompanhamento
              de verdade?
            </h3>
            <p className="text-sm text-white/80">
              Clique no botão abaixo, escolha seu plano e inicie agora sua
              evolução.<br></br>{" "}
              <strong className="text-red-600">
                ATENÇÃO: Nossas vagas são limitadas para garantir a qualidade do
                seu acompanhamento.
              </strong>
            </p>
          </div>
          <button
            ...
            className={cn(
              "mt-4 inline-flex items-center gap-2 rounded-2xl px-6 py-3 text-sm font-semibold transition sm:mt-0",
